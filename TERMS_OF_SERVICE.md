...
By clicking "I Accept" or by using teleWatcher ("the Service"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, do not use the Service.

We reserve the right to update these Terms at any time. Material changes will be announced via the Bot with a minimum of **7 days' advance notice** before taking effect. Continued use of the Service after changes constitutes acceptance of the revised Terms.

### 1.1 Developer Status and Legal Capacity

**The Developers (Galaxy-craft and Bclayn) are minors of seventeen (17) years of age under the laws of the Republic of Uzbekistan.** This disclosure is made in the interest of full transparency.
...
The Service is a Telegram-based monitoring tool that allows users to track activity in their own Telegram chats, including:
...
**Data Storage:**
User data is stored on servers located in San Francisco, United States. By using the Service, you provide explicit, informed consent to cross-border data transfer in accordance with Article 22(3) of Uzbekistan Law No. ZRU-547 "On Personal Data." For full details on data storage, processing, and your rights, please refer to the **[teleWatcher Privacy Policy]**, which forms part of this agreement under Section 13.3.

**Important:** The Service is NOT an official Telegram product and is not endorsed by Telegram Messenger Inc. Use of the Service may violate Telegram's Terms of Service. You use the Service at your own risk.

---

## 3. Eligibility

The Service is available to persons aged 16 years or older.

For users aged 16 to 18 years, parental or legal guardian consent is required. By using the Service, you confirm that you have obtained such consent.

By using the Service, you represent that:

- You are at least 16 years of age, AND
- You have obtained parental/guardian consent if you are under 18 years of age

**Important for users aged 16–17:**
Your parent or legal guardian should be aware that the Service may restore deleted media files, which could include sensitive or age-inappropriate content. By allowing you to use the Service, they acknowledge this risk.

**Enforcement:**
If we become aware that a user is under 16 years of age, we will immediately terminate their account and delete all associated data.
...
To use the Service, you must authorize your own Telegram account via MTProto API. This process is similar to logging into Telegram from a new device. You will be asked to provide:
...
- The security of your Telegram account, including use of strong passwords and two-factor authentication
- All actions performed through the Service under your account, including recovery and use of deleted messages and media files
- Accepting the risk that use of the Service may violate Telegram's Terms of Service and result in account suspension

### 4.3 Application Moderation

New user registrations require administrator approval. We reserve the right to reject any application without providing a reason.
...
- Blackmail, threats, or extortion
- Surveillance of other individuals without their explicit consent
- Distribution of personal content of third parties (photos, videos, messages) without their consent
- Invasion of privacy or other violations of applicable privacy and criminal laws of the Republic of Uzbekistan
- Collection of personal information for commercial purposes without consent
- Any activity that is unlawful under the laws of the Republic of Uzbekistan

You must not:

- Attempt to hack, reverse-engineer, or decompile the Service
- Use automated tools (bots) to interact with the Service
- Create multiple accounts as a single individual
...
- All actions performed using the Service
- All recovered and stored messages and media files
- The consequences of using recovered content
- Compliance with third-party privacy and data protection rights
- Any suspension or termination of your Telegram account

The Service provides a technical tool only. We are not responsible for how you use it.

### 6.4 Indemnification

**You agree to indemnify, defend, and hold harmless** the Developers (Galaxy-craft and Bclayn), their heirs, successors, and assigns from and against any and all claims, damages, losses, liabilities, costs, and expenses (including reasonable legal fees) arising out of or relating to:
...
We reserve the right to immediately suspend your account in the event of:

- Violation of Section 6.2 of these Terms
- A complaint from a third party regarding unlawful use of the Service
- Suspected illegal activity
- A request from law enforcement authorities of the Republic of Uzbekistan
...
- All data will be deleted within 24 hours

### 8.3 Account Deletion by Request

**Warning:** Account deletion is permanent and irreversible. All your data will be permanently deleted and cannot be recovered.

You may delete your account at any time by sending the command `/delete_account` to the Bot. Before proceeding with deletion, you will be asked to confirm your decision.

Upon deletion:

- All stored messages are deleted from the database within 24 hours
- All media files are deleted immediately
- All activity logs are deleted immediately
- The Telegram session is deactivated immediately
- Your phone number is removed from the database immediately

Recovery of data after deletion is not possible.
...
All rights, title, and interest in and to the Service (including but not limited to the source code, bot logic, design, functionality, and documentation) are the exclusive property of the Developers (Galaxy-craft and Bclayn).

### 9.2 Restrictions

You are granted a limited, non-exclusive, and revocable right to use the Service. You do not receive any rights to:

- Access, copy, or distribute the Service's source code;
- Use our logo without prior written consent;
- Reverse-engineer, decompile, or attempt to extract the underlying technologies used in the Service.

### 9.3 Third-Party Rights

The name "Telegram", its logo, and related trademarks are the property of Telegram Messenger Inc. This Service is an independent, third-party tool and is not affiliated with, authorized, or endorsed by Telegram.

### 9.4 Prohibited Use

Use of the Service does not grant you the right to distribute, copy, modify, or create derivative works based on any of its components.
...
- **Uninterrupted Operation:** The Service may experience downtime due to server maintenance, Telegram outages, or technical malfunctions.
- **Data Capture:** Due to the nature of the Telegram MTProto API, we do not guarantee the recovery of 100% of deleted or edited messages. If a message is deleted instantly or during a connection lag, it may not be captured.
- **Compatibility:** We do not guarantee that the Service will remain functional if Telegram Messenger Inc. updates its protocols, security measures, or API.

### 10.2 Beta Status

The Service is currently in Beta testing. You acknowledge that the Service is under active development and may contain bugs, experience temporary data loss, or undergo significant changes in functionality without prior notice.

### 10.3 Risk of Account Sanctions

You acknowledge that the use of third-party monitoring tools (Userbots) may violate Telegram's internal policies. **You have been explicitly warned** that your Telegram account may be suspended, limited, or permanently banned as a result of using the Service. You assume all risks associated with the use of your Telegram account via our Service, and you agree to indemnify the Developers against any claim arising from such sanctions pursuant to Section 6.4.

### 10.4 Force Majeure

The Developers shall not be liable for any failure or delay in the performance of the Service caused by circumstances beyond their reasonable control, including but not limited to:

- (a) **Telegram API changes:** Any modification, restriction, deprecation, or discontinuation of the Telegram MTProto API or Telegram's platform policies by Telegram Messenger Inc., including but not limited to rate limiting, session termination mechanisms, or anti-userbot enforcement measures;
- (b) **Infrastructure failures:** Outages, failures, or service interruptions of third-party hosting providers, data centres, or internet infrastructure;
- (c) **Legal or regulatory action:** Any order, injunction, or directive issued by a competent authority of the Republic of Uzbekistan or the United States that restricts or prohibits the operation of the Service;
- (d) **Cyberattacks:** Distributed denial-of-service attacks, unauthorized access attempts, or other malicious acts directed at the Service's infrastructure;
- (e) **Acts of God:** Natural disasters, pandemics, or other events beyond human control.
...
To the maximum extent permitted by the laws of the Republic of Uzbekistan:

### 11.1 General Exclusion
...
You are solely responsible for your compliance with Telegram's Terms of Service and the laws of the Republic of Uzbekistan regarding the privacy of correspondence. You acknowledge that using third-party tools (Userbots) involves risks that you personally assume.
...
You may not assign your rights and obligations under these Terms to any third party without our written consent.

We may assign our rights and obligations to any third party with notice to you.

### 13.3 Entire Agreement

These Terms, together with the **teleWatcher Privacy Policy** ([published at](https://github.com/bclayn24/teleWatcher-docs/blob/main/PRIVACY_POLICY.md)), constitute the entire agreement between you and the Developers (Galaxy-craft and Bclayn) regarding use of the Service. In the event of conflict between these Terms and the Privacy Policy on matters of data processing, the Privacy Policy shall prevail.
